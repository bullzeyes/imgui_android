...
void init(int surfaceWidth, int surfaceHeight, int windowWidth, int windowHeight, const char* outputDir)
{
    g_Time = 0.0;
...
{
    init(surfaceWidth, surfaceHeight, windowWidth, windowHeight, outputDir);
